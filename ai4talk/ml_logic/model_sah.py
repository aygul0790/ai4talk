...
def transcript_sah(file_name):

    checkpoint_path =  os.path.join(os.getcwd(),"checkpoints", "checkpoint_sah.ckpt")
    ...
    fpath = os.path.join(os.getcwd(),"processed_data","sah", file_name)
    df = pd.read_csv(os.path.join(os.getcwd(),"processed_data","sah", "metadata.csv"))
    df['audio_path'] = fpath
